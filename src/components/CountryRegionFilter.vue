<template>
  <div tabindex="0" class="field field--small field-select shadow bg-white dark:bg-[#2b3945]" @focusout="toggleList(false)">
    ...
    <label class="field__label" @click="toggleList(!open)">
      <icon class="i-bi-chevron-down" name="chevron" :class="{ 'rotate-transition' : true, 'rotate-transition--active' : open}"></icon>
    </label>
